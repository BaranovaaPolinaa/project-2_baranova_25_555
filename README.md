...
Примитивная база данных - модуль для управления таблицами. С помощью этой БД можно создавать, проверять и удалять таблицы, определять их структуру с типами данных и сохранять метаданные в JSON-файл для персистентности.
...
Модуль предоставляет базовую функциональность для работы с таблицами в небольшой БД.
...
Работа с данными внутри таблиц: добавление, чтение, обновление и удаление записи(ей).
